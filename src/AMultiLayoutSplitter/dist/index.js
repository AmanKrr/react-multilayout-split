...
export default class Split extends React.Component {
  ...
  onMouseDown(paneNumber, env) {
    ...
    this.startY = clientY;
    this.move = true;
    if (env.target.classList.contains("a-splitter-handlebar-icon") || env.target.classList.contains("a-splitter-collapse-icon")) {
  ...
  render() {
    ...
    const _b = this.props,
      {
        ...
        mode,
        visiable,
        visible = (_a = this.props.visible) !== null && _a !== void 0 ? _a : this.props.visiable,
        renderBar,
        lineBar,
        disable,
        onDragEnd,
    ...
    const { initialSizes, minSizes, maxSizes, enableSessionStorage, collapsed, height, width } = other,
      neededProps = __rest(other, ["initialSizes", "minSizes", "maxSizes", "enableSessionStorage", "collapsed", "height", "width"]);
    return _jsx(
      "div",
      Object.assign(
        { className: cls },
        neededProps,
        { ref: (node) => (this.warpper = node), style: { height: height, width: width } },
        {
          children: React.Children.map(child, (element, idx) => {
            ...
            if (idx !== 0 && visibleBar && renderBar) {
              BarCom = renderBar(
                Object.assign(Object.assign({}, barProps), {
            ...
            return _jsxs(
              React.Fragment,
              { children: [BarCom, React.cloneElement(_jsx("div", { children: element }), Object.assign({}, props))] },
              idx
            );
          }),
        }
